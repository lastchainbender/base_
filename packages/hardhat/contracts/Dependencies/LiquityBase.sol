...
* common functions. 
*/
contract LiquityBase is ILiquityBase, BOCLCustomBase {
    ...
    uint constant public CUSD_GAS_COMPENSATION = 20e18;

    // Minimum amount of net CUSD debt a must have
    ...
    function getEntireSystemDebt() public override view returns (uint) {
        uint activeDebt = activePool.getCUSDDebt();
        uint closedDebt = defaultPool.getCUSDDebt();
