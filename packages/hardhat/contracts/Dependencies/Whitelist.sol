...
contract Whitelist is OwnableUpgradeable, IWhitelist, IBaseOracle, CheckContract {
    ...
    function addCollateral(
        ...
        require(_safetyRatio < 11e17, "ratio must be less than 1.10"); //=> greater than 1.1 would mean taking out more CUSD than collateral VC
    ...
    function changeSafetyRatio(address _collateral, uint256 _newSafetyRatio)
        ...
        onlyOwner
    {
        require(_newSafetyRatio < 11e17, "ratio must be less than 1.10"); //=> greater than 1.1 would mean taking out more CUSD than collateral VC
    ...
    /* msg.sender is the BOCL contract calling this function
     * _caller is the caller of that contract on the BOCL contract
     * this function confirms whether the caller of the BOCL Contract is
