 ...
 */
contract ThreePieceWiseLinearPriceCurve is IPriceCurve, OwnableUpgradeable {
    ...
    /** 
     * Function for getting the fee for a particular collateral type based on percent of VST backed
     * by this asset. 
