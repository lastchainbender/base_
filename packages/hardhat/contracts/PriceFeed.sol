...
contract PriceFeed is OwnableUpgradeable, CheckContract, BaseMath, IPriceFeed {
    ...
    string constant public NAME = "BOCPriceFeed";
    ...
    // The last good price seen from an oracle by Bank of Cronos Loans
    ...
    /*
    * fetchPrice():
    * Returns the latest price obtained from the Oracle. Called by Bank of Cronos Loans functions that require a current price.
    *
    * Also callable by anyone externally.
    *
    * Non-view function - it stores the last good price seen by Bank of Cronos Loans.
    *
    ...
    */
    ...
    function _scaleChainlinkPriceByDigits(uint _price, uint _answerDigits) internal pure returns (uint) {
        /*
        * Convert the price returned by the Chainlink oracle to an 18-digit decimal for use by Bank of Cronos Loans.
        * At date of Bank of Cronos Loans launch, Chainlink uses an 8-digit price, but we also handle the possibility of
        * future changes.
        *
        */
        uint price;
        if (_answerDigits >= TARGET_DIGITS) {
            // Scale the returned price value down to Bank of Cronos Loans's target precision
            price = _price.div(10 ** (_answerDigits - TARGET_DIGITS));
        }
        else if (_answerDigits < TARGET_DIGITS) {
            // Scale the returned price value up to Bank of Cronos Loans's target precision
    ...
    function _getCurrentChainlinkResponse() internal view returns (ChainlinkResponse memory chainlinkResponse) {
        ...
        )
        {
            ...
            chainlinkResponse.timestamp = startedAt;
    ...
    function _getPrevChainlinkResponse(uint80 _currentRoundId, uint8 _currentDecimals) internal view returns (ChainlinkResponse memory prevChainlinkResponse) {
        ...
        *
        * Tectonic Pricefeeds don't have consistent roundIds for concurrent updates so retuning true until upgraded to Chainlink feeds
        */
        ...
        )
        {
            ...
            prevChainlinkResponse.timestamp = startedAt;
